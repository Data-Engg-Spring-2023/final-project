...
#load data
df = pd.read_csv("./stackoverflowdata/survey_results_public.csv", header = None)
...
numeric_df.columns = ['country', 'years']

#standard scaling age
age_std_scale = StandardScaler()
numeric_df['country'] = age_std_scale.fit_transform(numeric_df[['age']])
#standard scaling balance
balance_std_scale = StandardScaler()
numeric_df['years'] = balance_std_scale.fit_transform(numeric_df[['balance']])
